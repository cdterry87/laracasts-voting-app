        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between">
          ...
          <div class="flex items-center space-x-2 mt-4 md:mt-0" x-data="{ isOpen: false }">
            ...
            <button @click="isOpen = !isOpen"
              ...
              <ul x-cloak x-show="isOpen" x-transition.origin.top.left.duration.200ms @click.away="isOpen = false"
          ...
          <form action="" class="space-y-4 px-4 py-6">
            ...
            <div class="flex items-center space-x-3">
              ...
              <button type="button"
                ...
                <svg class="hidden md:block text-gray-600 w-4 transform -rotate-45" xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
        ...
        <div class="mx-1 md:mx-4 w-full mt-2 md:mt-0">
          ...
          <div class="flex items-center justify-between mt-6">
            ...
            <div class="flex items-center mt-2 md:mt-0 md:space-x-2" x-data="{isOpen: false}">
              <button @click="isOpen = !isOpen"
                class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in py-2 px-3 border">
                <svg fill="currentColor" class="text-gray-400" width="24" height="6">
                  <path
